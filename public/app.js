...
9. Responda SEMPRE em Português do Brasil.`,
    ...
    function handleQuickCommand(command) {
        ...
        const prompts = {
            ...
            prova: `Crie uma prova completa com 10 questões de múltipla escolha (A-E) sobre o tema que vou informar, no padrão ENADE/Revalida/Residência Médica. REQUISITOS OBRIGATÓRIOS:\n\n1. CADA questão DEVE iniciar com um Caso Clínico (Clinical Vignette) rico contendo: dados demográficos, queixa principal com temporalidade, história da moléstia atual detalhada, pelo menos 3 achados do exame físico, e resultados laboratoriais/imagem com valores numéricos realistas\n2. Alternativas de A a E com distratores altamente plausíveis (diagnósticos diferenciais reais que geram confusão na prática)\n3. Dificuldade progressiva: questões 1-3 (nível fácil), 4-7 (nível médio), 8-10 (nível difícil com pegadinhas comuns de prova)\n4. Ao final, GABARITO COMENTADO obrigatório para TODAS as questões: explique por que a correta é correta e por que CADA uma das alternativas erradas está errada, citando a fisiopatologia e guidelines relevantes\n5. Estruture como documento pronto para impressão com numeração e formatação limpa\n\nTema da Prova: `,

            docente: `Crie um plano de aula completo e profissional sobre o tema que vou informar, para uso em curso de graduação em Medicina. O plano deve conter:\n\n1. DADOS GERAIS: Disciplina, Período sugerido, Carga horária (em minutos), Pré-requisitos\n2. OBJETIVOS DE APRENDIZAGEM: Mínimo de 5 objetivos usando verbos da Taxonomia de Bloom (Conhecer, Compreender, Aplicar, Analisar, Avaliar, Criar)\n3. CONTEÚDO PROGRAMÁTICO: Tópicos organizados hierarquicamente\n4. METODOLOGIA: Divida a aula em fases com Timebox (ex: 0-10min → Warm-up com caso motivador, 10-30min → Exposição dialogada, 30-50min → Atividade PBL/TBL em grupo, 50-60min → Debriefing e síntese)\n5. RECURSOS DIDÁTICOS: Materiais necessários (projetor, simulador, peças anatômicas, etc.)\n6. AVALIAÇÃO: Proposta de avaliação formativa (durante a aula) e somativa (prova/trabalho)\n7. REFERÊNCIAS BIBLIOGRÁFICAS: Mínimo 3 fontes (livros-texto clássicos + guidelines atualizadas + artigos recentes)\n\nTema: `
        };
